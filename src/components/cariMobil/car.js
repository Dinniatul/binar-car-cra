...
const Car = () => {
  ...
  const populateCars = carData.map((item) => {
    ...
    <div>
      ...
      <div className="container-fluid" style={{ padding: "100px" }}>
        <div className="row d-flex justify-content-center">
          {displayCar.length == 0 ? (
            <center>
              <h1 className="mt-5 mb-5">Data Mobil Tidak Ada</h1>
            </center>
          ) : (
            displayCar.map((item) => (
                ...
                <div className="card " style={{ minHeight: "580px" }}>
                  <div className="card-body">
                    ...
                    <div className="row mt-auto" id="pilihMobil">
                      <button href="#" className="btn btn-success text-white w-100 fw-bold mt-auto " style={{ fontSize: "14px" }}>
                        Pilih Mobil
                      </button>
                    </div>
                  </div>
